...
<?php include(ROOT_PATH . "/app/controllers/banner.php");
adminOnly();
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        <div class="button-group">
            <a href="create.php" class="btn btn-big">Add Banner</a>
            <a href="index.php" class="btn btn-big">Manage Banner</a>
        </div>


        <div class="content">

            <h2 class="page-title">Manage Banner</h2>
                ...
                foreach ($banners as $key => $banner): ?>
                    <tr>
                        ...
                        <td class="imagePreviewContainer">
                            <img id="imagePreview" src="<?php echo BASE_URL . '/assets/images/' . $banner['image'] ?>" style="max-width: 45%; max-height: 100px; padding-top: 10px;">
                        </td>
                        <td><?php echo $banner['status'] == 1? 'Active' : 'Inactive'; ?></td>
                        <td>
                            <a href="edit.php?id=<?php echo $banner['id']; ?>" class="edit hover-text"><span class="tooltip-text" id="top">Edit</span><i class="fas fa-edit"></i></a>
                            <a href="edit.php?delete_id=<?php echo $banner['id']; ?>" class="delete hover-text"><span class="tooltip-text" id="top">Delete</span><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
